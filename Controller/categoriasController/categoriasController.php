...
class CategoriasController {
  ...
  echo'  <div class="col-md-8">  
              ...
              <label for="categoria-name" class="form-control-label">Nombre de la Categoría :</label>
        ...
        <input type="hidden" name="idcategoria" value="'.$respuesta['idcategoria'].'">
          <button type="submit" class="btn btn-primary" name="editarCategorias">Actualizar</button>
          </div>
   <div class="col-md-4">
