...
<nav class="navbar navbar-dark bg-warning">
  <button class="navbar-toggler hidden-lg-up" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"></button>
   ...
   <div class="collapse navbar-toggleable-md" id="navbarResponsive">
    ...
    <a class="navbar-brand" href="categorias"><i class="fa fa-universal-access" aria-hidden="true"></i> Categorías</a>
    ...
    <ul class="nav navbar-nav">
     ...
     <li class="nav-item dropdown nav-item active">
        ...
        <a class="navbar-brand" href="usuarios"><i class="fa fa-universal-access" aria-hidden="true"></i> Usuarios</a>
      <a class="navbar-brand" href="contacto"><i class="btn btn-primary btn-sm  fa fa-list-ol" aria-hidden="true"></i> Contacto</a>
