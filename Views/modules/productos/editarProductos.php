...
<div class="container">
  ...
  <ol class="breadcrumb">
     <li class="breadcrumb-item active"><i class="fa fa-list"> </i> EDITAR PRODUCTO </li>
  </ol>
 <form method="post">
    ...
    <input type="hidden" name="idproducto" value="<?php echo $key['idproducto']; ?>">
          ...
          <div class="row">
            <div class="col-md-6">  
              <div class="form-group">
                <label for="recipient-name" class="form-control-label">Nombre del Producto:</label>
                <input type="text" class="form-control" id="recipient-name" name="nombreproducto" value="<?php echo $key['nombreproducto'] ?>">
              </div>
            </div>
               <div class="col-md-6">  
             <div class="form-group">
              <label for="recipient-name" class="form-control-label">Categoría del Producto:</label>
      <select class="form-control chosen-select" id="idcategoria" name="idcategoria">     
          ...
          <div class="row">
            <div class="col-md-6"> 
             <div class="form-group">
              <label for="recipient-name" class="form-control-label">Precio del Producto :</label>
         ...
         <CENTER>
            <button type="submit" class="btn btn-primary" name="editarProductos">Actualizar</button>
         </CENTER>
         <br>
       </form>
 <?php endforeach ?>
