       ...
       <!-- ---- -->
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-6">  
              <div class="form-group">
                <label for="recipient-name" class="form-control-label">Nombre del Cliente:</label>
          ...
          <div class="row">
            ...
            <div class="col-md-6"> 
             <div class="form-group">
              <label for="recipient-name" class="form-control-label">Fecha de Reserva (1/10/2019):</label>
             ...
             <div class="form-group">
              ...
              <textarea class="form-control" id="message-text" name="observaciones" required="">Sin notas</textarea>
            </div>
            </div>
