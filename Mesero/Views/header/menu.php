...
<nav class="navbar navbar-dark bg-warning">
  ...
  <div class="collapse navbar-toggleable-md" id="navbarResponsive">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="nav-item dropdown nav-item active">
        <a class="nav-link dropdown-toggle" href="#" id="responsiveNavbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i class="fa fa-usd" aria-hidden="true"></i> Usuarios</a>
       ...
       <li class="nav-item dropdown  nav-item active float-xs-right">
         <a class="nav-link dropdown-toggle" href="#" id="responsiveNavbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-windows" aria-hidden="true"></i> Bienvenido! <?php echo  ' ' .strtoupper($_SESSION[ 'nombreusuario']); ?></a>
...
<nav class="navbar navbar-dark bg-warning">
  <button class="navbar-toggler hidden-lg-up" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"></button>
  <div class="collapse navbar-toggleable-md" id="navbarResponsive">
    <a class="navbar-brand" href="index"><i class="fa fa-usd" aria-hidden="true"></i> Reservas</a>
    <a class="navbar-brand" href="listadoProd"><i class="fa fa-product-hunt" aria-hidden="true"></i> Productos</a>
    <a class="navbar-brand" href="principalVentas"><i class="fa fa-table" aria-hidden="true"></i> Mesas</a>
    <ul class="nav navbar-nav">
